...
<button
	...
	disabled={!hasRecords}
	title={active ? (ascending ? 'Ascending order' : 'Descending order') : 'Click to sort records'}
>
	<Icon classes="cursor-pointer" icon={active ? (ascending ? faArrowUp : faArrowDown) : faSort} />
</button>
