...
<div class="flex flex-row justify-end items-center w-full {classes}" data-test="pageCtrl">
	...
	<div class="flex flex-row w-36 justify-center items-center">
		...
		<div class="font-bold bg-primary-700 dark:bg-primary-500 text-white py-2 px-4 rounded" title="Page {page}">
			{page}
		</div>
		<Button
			role="action"
